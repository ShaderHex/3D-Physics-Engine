...
void drawPlane3D(GLuint shaderProgram, 
    ...
    if (VAO == 0) {
        ...
        glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)(3 * sizeof(float)));  // aNormal
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, "GLFW Starter Window", NULL, NULL);
    if (!window) {
